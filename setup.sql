...
CREATE SCHEMA SNOWFLAKE_LEARNING_DB.WORKSHOP_BRONZE;
CREATE SCHEMA SNOWFLAKE_LEARNING_DB.WORKSHOP_SILVER;
CREATE SCHEMA SNOWFLAKE_LEARNING_DB.WORKSHOP_GOLD;
CREATE SCHEMA SNOWFLAKE_LEARNING_DB.WORKSHOP;
CREATE SCHEMA SNOWFLAKE_LEARNING_DB.WORKSHOP_ANOMALY_DETECTION;
